...
import com.tutorials.eu.favdish.databinding.DialogCostomListBinding
...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        when (v.id) {
            ...
            R.id.btn_add_dish -> {
                ...
                val dishTitle = mBinding.etTitle.text.toString().trim { it <= ' ' }
                val dishType = mBinding.etType.text.toString().trim { it <= ' ' }
                ...
                when {
                    ...
                    TextUtils.isEmpty(cookingDirection) -> {
                        ...
                        if (dishID == 0) {
                            ...
                            Log.e("Updating", "DISH Updated Successfully")
                        }
                        finish()
                    }
                }
    ...
    private fun customItemsListDialog(
        ...
        val binding: DialogCostomListBinding = DialogCostomListBinding.inflate(layoutInflater)
